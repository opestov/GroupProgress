...
let referenceBinaries = [ "GroupProgress.dll" ]
// Web site location for the generated documentation
let website = "/GroupProgress"

let githubLink = "http://github.com/opestov/GroupProgress"

// Specify more information about your project
let info =
  [ "project-name", "GroupProgress"
    "project-author", "Oleg Pestov"
    "project-summary", "short"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/GroupProgress" ]
